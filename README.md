 ...
 * Properties([@Terry](https://github.com/jtydhr88/))
 * Plugins([@Terry](https://github.com/jtydhr88/))
 ...
 * Workspace Plugins([@Terry](https://github.com/jtydhr88/))
 * Project Properties([@Terry](https://github.com/jtydhr88/))
 * Run instructions([@Terry](https://github.com/jtydhr88/))
 * Launching([@Terry](https://github.com/jtydhr88/))
 * Testing([@Terry](https://github.com/jtydhr88/))
 * Overriding the plugins([@Terry](https://github.com/jtydhr88/))
9. Generating JARs
 * Generating JARs
 * Project
 * Manifest
